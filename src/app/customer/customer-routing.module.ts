...
const routes: Routes = [
  { path: '', component: CustomerLandingPageComponent, children: [
  ...
  { path: 'home', component: CustomerHomeComponent, canActivate: [EKartRoutingGuard], children: [
      ...
      {path: 'todayDeals',component: ViewTodayDealsComponent},
      { path: 'cart', component: CustomerCartComponent },
      { path: 'password', component:  CustomerChangePasswordComponent},
